...
def pid_control():
    ...
    while running:          
        ...
        # ROTATION MODE: closed-loop absolute angle control (relative target)
        if control_mode == 'rotate':
            # Incremental encoder integration (robust to overflow, no resets needed)
            ...
            # Saturate and apply minimum thresholds
            ...
            # Determine settle condition: small error and small angular rate for a dwell time
            now = current_time
